...
Report bugs at https://{{ cookiecutter.repo_location }}/{{ cookiecutter.repo_username }}/{{ cookiecutter.project_slug }}/issues.
...
The best way to send feedback is to file an issue at https://{{ cookiecutter.repo_location }}/{{ cookiecutter.repo_username }}/{{ cookiecutter.project_slug }}/issues.
...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:<your_repo_username_here>/{{ cookiecutter.project_slug }}.git
